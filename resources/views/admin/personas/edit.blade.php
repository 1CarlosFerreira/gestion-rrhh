        ...
        <form method="POST" action="{{ route('admin.personas.update', $persona) }}" class="grid gap-5 rounded-xl bg-white p-6 shadow-sm md:grid-cols-2">
            ...
            <div class="border-t border-gray-100 pt-4 md:col-span-2">
                ...
                <label for="active" class="inline-flex items-center text-sm font-medium text-gray-700">
                    <input type="checkbox" name="active" id="active" value="1" @checked(old('active', $persona->active)) class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
