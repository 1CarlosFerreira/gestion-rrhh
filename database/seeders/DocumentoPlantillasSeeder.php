...
class DocumentoPlantillasSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DocumentoPlantilla::query()->updateOrCreate(
            ...
            [
                'tipo_tramite_id' => TipoTramite::query()->where('codigo', 'REEMPLAZO')->firstOrFail()->id,
                'tipo_documento_id' => TipoDocumento::query()->where('codigo', 'DOCUMENTO_GENERADO')->firstOrFail()->id,
                'nombre' => 'Solicitud de Reemplazo de Personal',
                'template_path' => 'pdf.reemplazos.solicitud',
                'mime_type' => 'application/pdf', 'sha256' => null, 'active' => true,
            ],
        );
    }
}
