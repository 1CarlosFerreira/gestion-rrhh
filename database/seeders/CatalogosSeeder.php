    ...
    private function procesos(): array
    {
        return [
            'REEMPLAZO' => [
                ...
                'transiciones' => [
                    ['BORRADOR', 'ENVIADA_GESTION_PERSONAS', 'ENVIAR', 'tramites.transicionar', false],
                    ['ENVIADA_GESTION_PERSONAS', 'EN_REVISION', 'INICIAR_REVISION', 'reemplazos.revisar_personal', false],
                    ['EN_REVISION', 'DEVUELTA_CORRECCION', 'DEVOLVER', 'reemplazos.devolver', true],
                    ['DEVUELTA_CORRECCION', 'ENVIADA_GESTION_PERSONAS', 'REENVIAR', 'tramites.transicionar', false],
                    ['EN_REVISION', 'LISTA_GENERAR_DOCUMENTO', 'APROBAR_REVISION', 'reemplazos.revisar_personal', false],
            ...
            'HORAS_EXTRAORDINARIAS' => [
                ...
                'transiciones' => [
                    ['BORRADOR', 'ENVIADA_GESTION_PERSONAS', 'ENVIAR', 'tramites.transicionar', false],
                    ['ENVIADA_GESTION_PERSONAS', 'PLANILLA_DISPONIBLE', 'CARGAR_PLANILLA', 'horas_extra.cargar_planilla', false],
                    ['PLANILLA_DISPONIBLE', 'EN_REVISION_JEFATURA', 'ENVIAR_A_REVISION', 'tramites.transicionar', false],
                    ['EN_REVISION_JEFATURA', 'OBSERVADA', 'OBSERVAR', 'horas_extra.revisar_planilla', true],
                    ['EN_REVISION_JEFATURA', 'CONFORME', 'CONFIRMAR_CONFORMIDAD', 'horas_extra.revisar_planilla', false],
                    ['OBSERVADA', 'EN_CORRECCION_SIRH', 'INICIAR_CORRECCION', 'tramites.transicionar', false],
                    ['EN_CORRECCION_SIRH', 'PLANILLA_DISPONIBLE', 'CARGAR_PLANILLA_CORREGIDA', 'horas_extra.cargar_planilla', false],
