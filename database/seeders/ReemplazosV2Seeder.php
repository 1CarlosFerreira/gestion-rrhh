...
class ReemplazosV2Seeder extends Seeder
{
    public function run(): void
    {
        ...
        $estados = [];
        foreach (['BORRADOR' => ['Borrador', 1], 'ENVIADA_GESTION_PERSONAS' => ['Enviada a Gestión de Personas', 2], 'EN_REVISION' => ['En revisión', 3], 'DEVUELTA_PARA_CORRECCION' => ['Devuelta para corrección', 4], 'LISTA_GENERAR_DOCUMENTO' => ['Lista para generar documento', 5], 'DOCUMENTO_GENERADO' => ['Documento generado', 6]] as $codigo => [$nombre, $orden]) {
