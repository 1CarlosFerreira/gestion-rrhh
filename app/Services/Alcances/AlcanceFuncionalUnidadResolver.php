...
namespace App\Services\Alcances;
...
class AlcanceFuncionalUnidadResolver
{
    ...
    public function incluye(User $user, UnidadOrganizacional $unidad, string|\DateTimeInterface $fecha): bool
    {
        if (! $unidad->activo) {
            return false;
        }
